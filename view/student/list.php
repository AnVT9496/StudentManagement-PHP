<?php require "layout/header.php" ?>
			...
			<a href="index.php?c=student&a=export" class="btn btn-success">Export</a>
			<a href="index.php?c=student&a=formImport" class="btn btn-warning">Import</a>
			...
			<table class="table table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td><?=$student->id?></td>
						<td><?=$student->name?></td>
						<td><?=Helper::formatVNBirthday($student->birthday)?></td>
